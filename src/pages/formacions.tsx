          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                ...
                <p className="text-lg">
                  Treure tensions, físiques i mentals, alleugerir l&#39;organisme en sí i poder-nos relaxar.
                </p>
                ...
                <p className="mt-6 text-lg">Format adaptable a les necessitats:</p>
          ...
          <div className="lg:col-span-3 lg:col-start-2 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-1 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                ...
                <p className="mt-6 text-lg">En aquests tallers aprendràs a proporcionar un “millor estar”.</p>
                <p className="mt-6 text-lg">Es tracta de potenciar i centrar-se en allò beneficiós que dona el Yoga.</p>
                <p className="mt-6 text-lg">
