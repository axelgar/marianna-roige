    ...
    <>
      ...
      <div className="bg-gray-50 lg:max-w-7xl lg:mx-auto mt-16 overflow-hidden relative">
        <img
          ...
          src="https://storage.googleapis.com/mariannaroige-images/formacions.webp"
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
            <img
              ...
              src="https://storage.googleapis.com/mariannaroige-images/relaxacio-mindfulness.webp"
              alt=""
            />
          </div>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="-ml-60 sm:-ml-80 lg:-ml-12 lg:sticky lg:top-4 lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:overflow-hidden rounded-xl">
            <img
              ...
              src="https://storage.googleapis.com/mariannaroige-images/ioga-adaptat.jpg"
